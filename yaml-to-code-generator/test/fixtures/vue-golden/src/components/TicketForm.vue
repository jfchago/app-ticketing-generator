  ...
  <form @submit.prevent="handleSubmit" class="entity-form">
    ...
    <div class="form-group">
      ...
      <select id="status" v-model="status" required>
        ...
        <option v-for="(label, value) in TicketStatus_LABELS" :key="value" :value="value">{{ label }}</option>
      </select>
    ...
    <div class="form-group">
      ...
      <select id="priority" v-model="priority" required>
        <option value="" disabled>Select...</option>
        <option v-for="(label, value) in TicketPriority_LABELS" :key="value" :value="value">{{ label }}</option>
      </select>
...
.error-message { color: #e74c3c; font-size: 0.85em; padding: 4px 0; }
</style>
